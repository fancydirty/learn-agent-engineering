...
Esto no es un riesgo teórico. Tiene nombre: **inyección de prompt**. Quien ataca nunca tiene que hablar con el agente directamente. Solo necesita esconder instrucciones en algún sitio que el agente vaya a leer tarde o temprano: un issue, un README, una página web, un archivo que alguien envíe. Leer contenido y recibir instrucciones viajan por el mismo canal.
