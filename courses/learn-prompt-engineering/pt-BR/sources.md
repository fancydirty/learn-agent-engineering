...
- supports: Conceitos centrais e boas práticas de prompt — estrutura básica de um prompt, few-shot learning, chain-of-thought.
...
- authority: official-docs
- supports: As seis estratégias de prompt engineering — escrever instruções claras, fornecer texto de referência, dividir tarefas complexas, dar ao modelo tempo para pensar, usar ferramentas externas e testar de forma sistemática.
...
- authority: official-docs
- supports: Técnicas de prompt específicas do Claude, incluindo tags XML, definição de papel e o tratamento de contextos longos.
...
- supports: A definição, o uso e as boas práticas do few-shot prompting.
...
- authority: authoritative-guide
- supports: O princípio, a implementação e os casos de uso do chain-of-thought prompting.
...
- authority: authoritative-guide
- supports: As tendências mais recentes e um guia abrangente de prompt engineering em 2026.
...
- authority: blog
- supports: As práticas de prompt engineering mais recentes de 2026 e as diferenças entre modelos.
...
- authority: blog
- supports: Um método sistemático para depurar e melhorar prompts de forma iterativa.
...
- authority: authoritative-guide
- supports: Recursos de aprendizado e boas práticas de prompt engineering em chinês.
...
- authority: authoritative-guide
- supports: Uma implementação detalhada do chain-of-thought prompting, com exemplos.
...
- authority: authoritative-guide
- supports: Os princípios de design e a aplicação prática do few-shot prompting.
...
- authority: blog
- supports: Boas práticas de prompt para cenários de geração de código.
...
- supports: A definição padrão de prompt e de prompt engineering.
...
- authority: encyclopedia
- supports: Os conceitos básicos e o funcionamento dos grandes modelos de linguagem.
...
- authority: encyclopedia
- supports: A definição e a aplicação do zero-shot learning.
