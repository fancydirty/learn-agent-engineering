...
- **El productor-revisor** es un bucle de escribir-un-borrador, recibir-retroalimentación, corregir, volver-a-revisar que se repite hasta converger[^S2]; bueno para tareas cuya calidad de salida necesita pulido repetido, con el costo determinado por la cantidad de rondas, así que suele necesitar un tope máximo de rondas.
