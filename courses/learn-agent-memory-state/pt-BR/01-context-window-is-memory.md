...
- "O agente lembra da nossa conversa anterior" é uma ilusão: a verdade é que a aplicação hospedeira reempacota o histórico completo em cada requisição, e o modelo não armazena nada por conta própria[^S6]
