...
>
> Pré-requisitos: você leu as Lições 1-5 e sabe rodar o loop do harness do Curso 7 desta série, “Fundamentos do Harness de Agente: Laços e Controle” | Anterior: [Lição 5 <<](./05-rewind-and-fork.md)
